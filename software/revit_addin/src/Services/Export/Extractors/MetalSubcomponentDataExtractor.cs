...
{
    public class MetalSubcomponentDataExtractor : IComponentDataExtractor
    {
        ...
        private static string FindProductName(RevitTypeContext context)
        {
            string fromType = RevitParameterSearchService.FindFirstParameterValue(
                ...
                new[]
                {
                    "Description", "Descripción", "Model", "Modelo",
                    "Product Name", "Nombre del Producto", "Nombre del producto",
                    "Product Code", "Código de Producto", "Codigo de Producto"
                },
                context.Document);
        ...
        {
            string manufacturer = FindFirst(context, new[] { "Manufacturer", "Fabricante", "Marca" });
